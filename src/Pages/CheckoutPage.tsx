      ...
      <div className="m-auto bg-white w-[90%] rounded-lg shadow-lg">
        <div className="relative h-full">
          <div className="p-8 lg:overflow-auto lg:h-[calc(100vh-60px)]">
            <h2 className="text-2xl font-bold text-[#4CBB17] mb-4">Order Summary</h2>
            <div className="mt-10 space-y-6">
              <div className="grid items-start grid-cols-2">
                <div className="items-center justify-center p-12 overflow-hidden bg-cover rounded-md h-28 w-28 sm:h-36 sm:w-36" style={{backgroundImage: "url('/lemon.webp')"}}>
                </div>
                <div className="pt-6 ml-4 ">
                  <h3 className="text-base text-[#4CBB17] font-bold">Product name</h3>
                  <ul className="mt-4 space-y-3 text-xs text-black lg:text-sm">
                    <li className="flex flex-wrap gap-4">Quantity <span className="ml-auto font-bold">2</span></li>
                    <li className="flex flex-wrap gap-4">Total Price <span className="ml-auto font-bold">$0.00</span></li>
                  </ul>
                </div>
              </div>
              <div className="grid items-start grid-cols-2">
          ...
          <div className="absolute left-0 bottom-0 bg-[#4CBB17] w-full p-4">
            <h4 className="flex flex-wrap gap-4 text-base font-semibold text-white">Total <span className="ml-auto">$0.00</span></h4>
          </div>
        </div>
      </div>
      <div className="sticky top-0 p-8 rounded-md xl:col-span-2 h-max">
        <h2 className="text-2xl font-bold text-[#4CBB17]">Complete your order</h2>
        <form className="mt-10">
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-6 mt-10 max-sm:flex-col">
              ...
              <button type="button" className="rounded-md px-6 py-3 w-full text-sm font-semibold bg-[#4CBB17] text-white hover:opacity-75">Complete Purchase</button>
            </div>
          </div>
        </form>
      </div>
